 ...
 * @author HD
 */
public class TutorialFase5p3 extends javax.swing.JFrame {

    /**
     * Creates new form TutorialFase1
     */
    public TutorialFase5p3() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel19.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Animais/elefante.gif"))); // NOI18N
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Animais/girafa.gif"))); // NOI18N
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/BotoesAnimais/Girafa.png"))); // NOI18N
        getContentPane().add(jLabel3);
        jLabel3.setBounds(690, 180, 90, 30);

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/BotoesAnimais/Elefante.png"))); // NOI18N
        getContentPane().add(jLabel2);
        jLabel2.setBounds(210, 180, 110, 28);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TutorialFase5p3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TutorialFase5p3().setVisible(true);
            }
        });
    }
