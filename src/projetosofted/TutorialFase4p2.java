 ...
 * @author HD
 */
public class TutorialFase4p2 extends javax.swing.JFrame {

    /**
     * Creates new form TutorialFase1
     */
    public TutorialFase4p2() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel19.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Alimentos/bolo.gif"))); // NOI18N
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Alimentos/chiclete.gif"))); // NOI18N
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/BotoesAlimentos/Chiclete.png"))); // NOI18N
        getContentPane().add(jLabel3);
        jLabel3.setBounds(690, 180, 110, 30);

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/BotoesAlimentos/Bolo.png"))); // NOI18N
        getContentPane().add(jLabel2);
        jLabel2.setBounds(210, 180, 63, 28);
    ...
    private void jButtonContinuarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonContinuarActionPerformed
        dispose();
        new TutorialFase4p2().setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TutorialFase4p2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
